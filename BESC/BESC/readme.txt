========================================================================
    メイクファイル プロジェクト: BESC プロジェクトの概要
========================================================================

この BESC プロジェクトは、AppWizard により作成されました。

このファイルには、BESC プロジェクトを構成する各ファイルの内容の概略が記述されています。
...
//// Makefileについて
all, clean, flashの3つのコマンドがが定義されていますが，このうちのflashコマンドは，ビルドされた.binファイルをターゲットのマイコンに書き込むものです．

//// flash.bat
Windows向けスクリプト．ターゲットに書き込みます．
